...
internal static class NetworkingCorrelationContractFixture
{
    internal static NetworkingSnapshot Create(bool legacy = false)
    {
        ...
        return new NetworkingSnapshot(
            ...
            HttpRequestsStarted: 3, HttpRequestsStopped: 3, HttpRequestsFailed: 0,
            ...
            TimeInQueueMax: default, DnsLookupsStarted: 3, DnsLookupsStopped: 3, DnsLookupsFailed: 0,
            DnsP50: default, DnsP95: default, DnsMax: default, TlsHandshakesStarted: 3,
            TlsHandshakesStopped: 3, TlsHandshakesFailed: 0, TlsP50: default, TlsP95: default, TlsMax: default,
