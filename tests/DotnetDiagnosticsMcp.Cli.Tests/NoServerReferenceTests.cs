...
/// <c>using DotnetDiagnosticsMcp.Server…</c> that drags in a Server type) would silently re-couple
...
public sealed class NoServerReferenceTests
{
    ...
    public void CliAssembly_DoesNotReferenceServerAssembly()
    {
        ...
        referenced.Should().NotContain("DotnetDiagnosticsMcp.Server");
    }
    ...
    public void CliAssembly_ReferencesCoreAssembly()
    {
        ...
        referenced.Should().Contain("DotnetDiagnosticsMcp.Core");
    }
}
