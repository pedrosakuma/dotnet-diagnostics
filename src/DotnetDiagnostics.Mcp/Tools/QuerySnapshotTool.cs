...
public sealed partial class QuerySnapshotTool
{
    ...
    public static async Task<DiagnosticResult<object>> QuerySnapshotCursorPaged(
        ...
        [Description("Activities view='trace' only: required non-zero 32-hex W3C trace-id. Matching is case-insensitive and output is normalized to lowercase.")] string? traceId = null,
