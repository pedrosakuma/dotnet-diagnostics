...
public sealed class OrchestratorOptions
{
    ...
    /// configuration. Default: <c>ghcr.io/pedrosakuma/dotnet-diagnostics:0.3.1</c>
    ...
    /// <c>ghcr.io/pedrosakuma/dotnet-diagnostics@sha256:...</c>) so the injected
    /// sidecar bytes are immutable across replicas and re-attaches.
    /// </summary>
    public string EphemeralContainerImage { get; set; } = "ghcr.io/pedrosakuma/dotnet-diagnostics:0.3.1";
    ...
    /// (docs/authorization.md#scopes). The flag remains accepted as a deployment-wide alias so
