...
/// <see cref="DotnetDiagnostics.Core.DiagnosticError.Kind"/> without conversion.
/// </remarks>
...
/// MCP tool layer catches these and maps them to <see cref="DotnetDiagnostics.Core.DiagnosticResult{T}"/>
