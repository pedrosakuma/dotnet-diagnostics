...
public static class CollectionHandleKinds
{
    ...
    /// <summary>Handle backing a <see cref="Jit.JitSnapshot"/> emitted by <c>collect_events(kind="jit")</c>.</summary>
    public const string JitSnapshot = "jit-snapshot";
    ...
    /// <summary>Handle backing a <see cref="Contention.ContentionSnapshot"/> emitted by <c>collect_events(kind="contention")</c>.</summary>
    public const string ContentionSnapshot = "contention-snapshot";
