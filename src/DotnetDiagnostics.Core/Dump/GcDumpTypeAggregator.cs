...
internal sealed class GcDumpTypeAggregator
{
    ...
    /// both views are directly comparable with the ClrMD-backed inspectors. Snapshots under the lock
    /// so a late-draining EventPipe reader cannot mutate the dictionaries mid-enumeration.</summary>
