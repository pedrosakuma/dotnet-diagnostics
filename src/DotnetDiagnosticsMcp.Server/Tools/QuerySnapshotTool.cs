...
public sealed class QuerySnapshotTool
{
    ...
    [Description(
        ...
        "(summary | byProvider | byType | recent | events | pauseHistogram | longestPauses | byGeneration | byEventName | bySource | byOperation | activities | byCategory | byLevel | errors | timeline | hillClimbing | workItemOrigins | byCallSite | byOwner | byCommand | n+1 | connectionPool); " +
