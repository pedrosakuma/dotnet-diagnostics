...
| [`multi-version-target-support.md`](./multi-version-target-support.md) | [#884](https://github.com/pedrosakuma/dotnet-diagnostics/issues/884) | Whether target processes on older .NET (6/7/8/9) can be diagnosed today — empirically confirmed working end-to-end on .NET 6, 8, and 9 with zero code changes; official scope recommendation of .NET 8+ is a maintenance/EOL decision, not a technical gap |
