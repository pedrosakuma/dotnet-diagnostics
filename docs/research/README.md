...
|---|---|---|
| [`icu-symbol-feasibility.md`](./icu-symbol-feasibility.md) | [#987](https://github.com/pedrosakuma/dotnet-diagnostics/issues/987) | Exact-image Windows ICU availability and completed offline DIA lookup: age 1 accepted, excluded-end name marked questionable; historical sampled coverage remains unestablished |
