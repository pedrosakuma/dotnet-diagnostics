...
| [`prospective-counter-evidence-contract.md`](./prospective-counter-evidence-contract.md) | Explicit opt-in counter evidence v2 projection and prospective magnitude/abnormality/causality and capability-aware recommendation guidance |
