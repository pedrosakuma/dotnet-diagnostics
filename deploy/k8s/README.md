...
The dev overlay scopes discovery to `diagnosticsmcp-dev`, generates a placeholder bearer Secret, and keeps the image on `ghcr.io/pedrosakuma/dotnet-diagnostics:0.17.0`.
