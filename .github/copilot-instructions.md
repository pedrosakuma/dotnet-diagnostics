...
- **Build:** `dotnet build DotnetDiagnostics.slnx -c Release`
- **Test:** `dotnet test DotnetDiagnostics.slnx -c Release --no-build` (live Core tests spawn a real sample process and need ~10s each)
